...
def UpdateLoop():
    while True:
        ...
        window['_currentCoords_'].update(
            "Current Coordinates: X:{}, Y:{}, Z:{}".format(int(griX), int(griY), int(griZ)))
...
if __name__ == '__main__':
    window, graph, side, coordText = GUIWindow("Test Window", createLayout()).createNewWindow()
